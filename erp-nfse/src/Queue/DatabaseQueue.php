...
final class DatabaseQueue
{
    ...
    /**
     * Enfileira um novo job. Retorna o ID do job inserido.
     */
    ...
    /**
     * Reivindica e reserva atomicamente o próximo job disponível.
     * Usa SELECT ... FOR UPDATE SKIP LOCKED para que dois workers
     * nunca peguem o mesmo job — sem Redis, sem race condition.
     */
    ...
    /**
     * Marca o job como falho. Se $retry = true e ainda há tentativas disponíveis,
     * volta para 'pending' com back-off exponencial (5, 20, 45 minutos).
     */
    ...
    /**
     * Retorna contagem de jobs por status. Útil para dashboards.
     */
